    ...
    <AdminLayout title="Add Product">
        <div class="container">
            ...
            <div class="col-md-12">
                ...
                <!-- button -->
                <div>
                    <Link :href="route('admin.products')" class="btn btn-light">Back to Product</Link>
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="col-lg-8 col-12">
                ...
                <div class="card-body p-6">
                    ...
                    <div class="mb-3 col-lg-6">
                        <InputLabel class="form-label">Title</InputLabel>
                        <TextInput type="text" name="title" class="form-control" placeholder="Product Name" required="required" />
                    </div>
                    <!-- input -->
                    <div class="mb-3 col-lg-6">
