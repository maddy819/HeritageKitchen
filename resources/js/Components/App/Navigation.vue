<script setup>
    ...
    import LocationModal from "@/Components/App/Modals/LocationModal.vue";
    import CartModal from '@/Components/App/Modals/CartModal.vue';
    ...
    onMounted(async () => {
        dropdownInstance = new bootstrap.Dropdown(dropdownBtn.value);
    });
...
<template>
                ...
                <div class="col-6 text-end d-none d-md-block">
                    <div class="dropdown selectBox">
                        <a class="dropdown-toggle selectValue text-reset" href="javascript:void(0)"
                            @click.prevent="toggleDropdown" ref="dropdownBtn">
                            <span class="me-2">
        ...
        <div class="container">
            <div class="row w-100 align-items-center gx-lg-2 gx-0">
                <div class="col-xxl-2 col-lg-3 col-md-6 col-5">
                    <Link class="navbar-brand d-none d-lg-block" :href="route('home')">
                ...
                <div class="col-md-2 col-xxl-3 d-none d-lg-block">
                    ...
                    <button type="button" class="btn btn-outline-gray-400 text-muted" @click.prevent="openModal">
                ...
                <div class="col-lg-2 col-xxl-2 text-end col-md-6 col-7">
                    <div class="list-inline">
                        ...
                        <div v-if="$page.props.auth.isAuthenticated" class="list-inline-item me-5">
                            <Link :href="$page.props.auth.role === 'admin' ? route('admin.dashboard') : route('customer.dashboard') " class="text-muted">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="list-inline-item me-5 me-lg-0">
                            <a class="text-muted position-relative" href="javascript:void(0)" @click.prevent="openCartModal">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="list-inline-item d-inline-block d-lg-none">
                            <!-- Button -->
                            <button class="navbar-toggler collapsed" type="button" @click="toggleOffcanvas">
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-default py-0 pb-lg-4" aria-label="Offcanvas navbar large">
        <div class="container">
            <div class="offcanvas offcanvas-start" :class="{ show: isOffcanvasOpen }" tabindex="-1" id="navbar-default"
                ...
                <div class="offcanvas-body">
                    ...
                    <div>
                        <ul class="navbar-nav align-items-center">
                            <li class="nav-item dropdown w-100 w-lg-auto active">
                                <Link class="nav-link active" :href="route('home')" role="button" aria-expanded="false">Home</Link>
                            </li>
                            <li class="nav-item dropdown w-100 w-lg-auto">
                                <Link class="nav-link" :href="route('about')" role="button" aria-expanded="false">About Us</Link>
                            </li>
                            <li class="nav-item dropdown w-100 w-lg-auto">
                                <Link class="nav-link" :href="route('contact')" role="button" aria-expanded="false">Contact Us</Link>
                            </li>
                            <li v-if="!$page.props.auth.isAuthenticated" class="nav-item dropdown w-100 w-lg-auto">
                                <Link class="nav-link" :href="route('login')" role="button" aria-expanded="false">Login</Link>
                            </li>
                            <li v-if="!$page.props.auth.isAuthenticated" class="nav-item dropdown w-100 w-lg-auto">
                                <Link class="nav-link" :href="route('signup')" role="button" aria-expanded="false">Sign Up</Link>
                            </li>
