<template>
    <div ref="cartModalRef" class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
...
const open = () => {
    if (offcanvasInstance) {
        ...
        console.error('Offcanvas instance not initialized');
    }
};
...
onMounted(() => {
    ...
    if (typeof window.bootstrap !== 'undefined' && cartModalRef.value) {
        offcanvasInstance = new window.bootstrap.Offcanvas(cartModalRef.value);
        console.log('Offcanvas initialized successfully');
    } else if (typeof bootstrap !== 'undefined' && cartModalRef.value) {
        offcanvasInstance = new bootstrap.Offcanvas(cartModalRef.value);
        console.log('Offcanvas initialized successfully');
    } else {
