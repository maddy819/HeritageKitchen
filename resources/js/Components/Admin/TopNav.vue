		...
		<div class="container-fluid">
			<div class="d-flex justify-content-between align-items-center w-100">
				<div class="d-flex align-items-center">
					<a class="text-inherit d-block d-xl-none me-4" @click="toggle" role="button" aria-controls="offcanvasExample">
				...
				<div>
					<ul class="list-unstyled d-flex align-items-center mb-0 ms-5 ms-lg-0">
						<li class="dropdown">
							<button ref="dropdownBtn" class="position-relative btn-icon btn-ghost-secondary btn rounded-circle" role="button" @click.prevent="toggleDropdown">
						...
						<li class="dropdown ms-4">
							<a ref="dropdownBtn" role="button" href="#" @click.prevent="toggleDropdown">
								<img src="/assets/images/avatar/avatar-1.jpg" alt="" class="avatar avatar-md rounded-circle" />
							</a>
							...
							<div class="dropdown-menu dropdown-menu-end p-0">
								...
								<div class="border-top px-5 py-3">
									<Link class="nav-link" :href="route('logout')" method="post">Log Out</Link>
								</div>
							</div>
						</li>
					</ul>
